# 1 "/media/nfs/home/mjd/Projects/IP-rotator/IP-rotator.ino"
/*
...
|   / -_) '  \/ _ \  _/ -_) (_) || | | __ |_/ _/ _ \ '  |_|_\___|_|_|_\___/\__\___|\__\_\|_| |_||_(_)__\___/_|_|_|
|
...
# 179 "/media/nfs/home/mjd/Projects/IP-rotator/IP-rotator.ino" 2
...
// interrupts
# 218 "/media/nfs/home/mjd/Projects/IP-rotator/IP-rotator.ino" 2
...
# 254 "/media/nfs/home/mjd/Projects/IP-rotator/IP-rotator.ino" 2
...
int i = 0;
# 280 "/media/nfs/home/mjd/Projects/IP-rotator/IP-rotator.ino" 2
# 281 "/media/nfs/home/mjd/Projects/IP-rotator/IP-rotator.ino" 2
# 282 "/media/nfs/home/mjd/Projects/IP-rotator/IP-rotator.ino" 2
# 337 "/media/nfs/home/mjd/Projects/IP-rotator/IP-rotator.ino"
int Altitude = 0;
...
//ajax
# 345 "/media/nfs/home/mjd/Projects/IP-rotator/IP-rotator.ino" 2
# 346 "/media/nfs/home/mjd/Projects/IP-rotator/IP-rotator.ino" 2
# 347 "/media/nfs/home/mjd/Projects/IP-rotator/IP-rotator.ino" 2
WebServer ajaxserver(80 /* Web server port*/+8);
...
int UDPpacketSize;
byte TxUdpBuffer[8];
# 367 "/media/nfs/home/mjd/Projects/IP-rotator/IP-rotator.ino" 2
...
# 373 "/media/nfs/home/mjd/Projects/IP-rotator/IP-rotator.ino" 2
# 374 "/media/nfs/home/mjd/Projects/IP-rotator/IP-rotator.ino" 2


# 377 "/media/nfs/home/mjd/Projects/IP-rotator/IP-rotator.ino" 2
# 378 "/media/nfs/home/mjd/Projects/IP-rotator/IP-rotator.ino" 2
# 379 "/media/nfs/home/mjd/Projects/IP-rotator/IP-rotator.ino" 2
  AsyncWebServer OTAserver(82);




# 385 "/media/nfs/home/mjd/Projects/IP-rotator/IP-rotator.ino" 2
...
# 430 "/media/nfs/home/mjd/Projects/IP-rotator/IP-rotator.ino" 2
# 469 "/media/nfs/home/mjd/Projects/IP-rotator/IP-rotator.ino"
// https://github.com/PaulStoffregen/RadioHead
# 494 "/media/nfs/home/mjd/Projects/IP-rotator/IP-rotator.ino"
const int RpmPin = 39;
...
// ntp
# 529 "/media/nfs/home/mjd/Projects/IP-rotator/IP-rotator.ino" 2
...
WiFiClient SerialServerClients[1];

int TelnetServerIPport = 23;
WiFiServer TelnetServer;
WiFiClient TelnetServerClients[1];
...
// DS18B20
# 601 "/media/nfs/home/mjd/Projects/IP-rotator/IP-rotator.ino"
//-------------------------------------------------------------------------------------------------------

void setup() {

  pinMode(AzimuthPin, 0x01);
  // pinMode(CwCcwButtPin, INPUT);
  pinMode(CwInputPin, 0x01);
  pinMode(CcwInputPin, 0x01);

  pinMode(HWidPin, 0x01);
  ...
  pinMode(VoltagePin, 0x01);
  pinMode(ReversePin, 0x02);
    digitalWrite(ReversePin, 0x0);
  ...
  // HardwareRev 1
  pinMode(AZmasterPin, 0x01);
  pinMode(ACcwPin, 0x02);
    digitalWrite(ACcwPin, 0x0);
  pinMode(BrakePin, 0x02);
    digitalWrite(BrakePin, 0x0);
  pinMode(LedRPin, 0x02);
    digitalWrite(LedRPin, 0x0);
  // pinMode(LedGPin, OUTPUT);
  //   digitalWrite(LedGPin, HIGH);
  pinMode(LedBPin, 0x02);
    digitalWrite(LedBPin, 0x0);

  pinMode(AZtwoWirePin, 0x02);
    digitalWrite(AZtwoWirePin, 0x0);
  pinMode(AZpreampPin, 0x02);
    digitalWrite(AZpreampPin, 0x0);
  ...
  // }
# 671 "/media/nfs/home/mjd/Projects/IP-rotator/IP-rotator.ino"
  pinMode(RpmPin, 0x01);
...
# 801 "/media/nfs/home/mjd/Projects/IP-rotator/IP-rotator.ino"
...
*/
# 811 "/media/nfs/home/mjd/Projects/IP-rotator/IP-rotator.ino"
                               )){
...
# 1191 "/media/nfs/home/mjd/Projects/IP-rotator/IP-rotator.ino"
  ...
  if(EEPROM.readByte(240)!=255){
    ...
    // ETH.begin();
    ETH.begin(0, 0 /*12                // #define ETH_PHY_POWER 0 ./Arduino/hardware/espressif/esp32/variants/esp32-poe/pins_arduino.h*/, 23 /* MDC pin17*/, 18 /* MDIO pin16*/, ETH_PHY_LAN8720, ETH_CLOCK_GPIO17_OUT /* CLKIN pin5 | settings for ESP32 GATEWAY rev f-g*/);
    ...
    OTAserver.begin();
# 1276 "/media/nfs/home/mjd/Projects/IP-rotator/IP-rotator.ino"
  TelnetServer.begin(TelnetServerIPport);
  // TelnetlServer.setNoDelay(true);
# 1332 "/media/nfs/home/mjd/Projects/IP-rotator/IP-rotator.ino"
  //------------------------------------------------

  // digitalWrite(EnablePin,0);

  // WDT
  esp_task_wdt_init(73, true); //enable panic so ESP32 restarts
  esp_task_wdt_add(
# 1338 "/media/nfs/home/mjd/Projects/IP-rotator/IP-rotator.ino" 3 4
                  __null
# 1338 "/media/nfs/home/mjd/Projects/IP-rotator/IP-rotator.ino"
...
void Watchdog(){
  ...
  if(millis()-ADCTimer > 5){
    ...
    if(ADCCounter > 34){
      ...
      VoltageBuffer = 0;
      CwCcwInputValue = 0;
      if(digitalRead(CwInputPin)==0x0){
        CwCcwInputValue = 1;
      }
      if(digitalRead(CcwInputPin)==0x0){
        CwCcwInputValue = 2;
      }
      ...
      case -11: {
        ...
        if(ACmotor==false){
          ...
          if(Reverse==false){ // CCW
            digitalWrite(ACcwPin, 0x0);
            digitalWrite(ReversePin, 0x1);
          }else{ // CW
            digitalWrite(ACcwPin, 0x1);
            digitalWrite(ReversePin, 0x0);
          }
          Status=-2;
        }
...
*/
# 2429 "/media/nfs/home/mjd/Projects/IP-rotator/IP-rotator.ino"
                                   ; i++){
...
*/
# 2462 "/media/nfs/home/mjd/Projects/IP-rotator/IP-rotator.ino"
                                    ; i++){
            EEPROM.write(i, 0xff);
            Prn(OUT, 0,".");
          }
...
*/
# 2759 "/media/nfs/home/mjd/Projects/IP-rotator/IP-rotator.ino"
                                    ; i++){
            EEPROM.write(i, 0xff);
            Prn(OUT, 0,".");
          }
...
*/
# 2777 "/media/nfs/home/mjd/Projects/IP-rotator/IP-rotator.ino"
                                   ; i++){
          if( (i<41)||(i>140&&i<208)||(i>212) ){ // hiden pass
            Prn(OUT, 0, String(i));
            Prn(OUT, 0, ">" );
...
# 3030 "/media/nfs/home/mjd/Projects/IP-rotator/IP-rotator.ino"
      Prn(OUT, 1,"  WIFI: OFF");
    ...
    // }
    Prn(OUT, 1,"-----------------  Sensors  -----------------");
# 3131 "/media/nfs/home/mjd/Projects/IP-rotator/IP-rotator.ino"
    // if(EnableSerialDebug>0){
    // }else{
    // }
    // Azimuth();
...
# 3290 "/media/nfs/home/mjd/Projects/IP-rotator/IP-rotator.ino"
    ...
    while (webClient.connected()) {
      if (webClient.available()) {
        ...
        if (c == '\n' && currentLineIsBlank) {
          ...
          // send a standard http response header
          webClient.println(((reinterpret_cast<const __FlashStringHelper *>(("HTTP/1.1 200 OK")))));
          webClient.println(((reinterpret_cast<const __FlashStringHelper *>(("Content-Type: text/html")))));
          webClient.println(((reinterpret_cast<const __FlashStringHelper *>(("Connection: close"))))); // the connection will be closed after completion of the response
          webClient.println();
          webClient.println(((reinterpret_cast<const __FlashStringHelper *>(("  <!DOCTYPE html>")))));
          webClient.println(((reinterpret_cast<const __FlashStringHelper *>(("  <html>")))));
          webClient.println(((reinterpret_cast<const __FlashStringHelper *>(("      <head>")))));
          webClient.println(((reinterpret_cast<const __FlashStringHelper *>(("          <meta http-equiv=\"Content-Type\" content=\"text/html;charset=utf-8\"/>")))));
          webClient.println(((reinterpret_cast<const __FlashStringHelper *>(("          <meta name=\"viewport\" content=\"width=device-width, initial-scale=1\">")))));
          // webClient.println(F("          <meta http-equiv=\"refresh\" content=\"10\">"));
          webClient.println(((reinterpret_cast<const __FlashStringHelper *>(("          <link rel=\"stylesheet\" type=\"text/css\" href=\"https://remoteqth.com/mqtt-wall/style.css\">")))));
          // TITLE
          webClient.print(((reinterpret_cast<const __FlashStringHelper *>(("           <title>IP rotator ")))));
          webClient.print(YOUR_CALL);
          webClient.println(((reinterpret_cast<const __FlashStringHelper *>(("</title>")))));
          // END TITLE
          webClient.println(((reinterpret_cast<const __FlashStringHelper *>(("          <link rel=\"apple-touch-icon\" sizes=\"180x180\" href=\"style/apple-touch-icon.png\">")))));
          webClient.println(((reinterpret_cast<const __FlashStringHelper *>(("          <link rel=\"mask-icon\" href=\"style/safari-pinned-tab.svg\" color=\"#5bbad5\">")))));
          webClient.println(((reinterpret_cast<const __FlashStringHelper *>(("          <link rel=\"icon\" type=\"image/png\" href=\"style/favicon-32x32.png\" sizes=\"32x32\">")))));
          webClient.println(((reinterpret_cast<const __FlashStringHelper *>(("          <link rel=\"icon\" type=\"image/png\" href=\"style/favicon-16x16.png\" sizes=\"16x16\">")))));
          webClient.println(((reinterpret_cast<const __FlashStringHelper *>(("          <link rel=\"manifest\" href=\"style/manifest.json\">")))));
          webClient.println(((reinterpret_cast<const __FlashStringHelper *>(("          <link rel=\"shortcut icon\" href=\"style/favicon.ico\">")))));
          webClient.println(((reinterpret_cast<const __FlashStringHelper *>(("          <meta name='apple-mobile-web-app-capable' content='yes'>")))));
          webClient.println(((reinterpret_cast<const __FlashStringHelper *>(("          <meta name='mobile-web-app-capable' content='yes'>")))));
          webClient.println(((reinterpret_cast<const __FlashStringHelper *>(("          <meta name=\"msapplication-config\" content=\"style/browserconfig.xml\">")))));
          webClient.println(((reinterpret_cast<const __FlashStringHelper *>(("          <meta name=\"theme-color\" content=\"#ffffff\">")))));
          webClient.println(((reinterpret_cast<const __FlashStringHelper *>(("          <script type=\"text/javascript\">")))));
          webClient.println(((reinterpret_cast<const __FlashStringHelper *>(("          var config = {")))));
          webClient.println(((reinterpret_cast<const __FlashStringHelper *>(("              server: {")))));
          webClient.print(((reinterpret_cast<const __FlashStringHelper *>(("                  uri: \"ws://")))));
          webClient.print(mqtt_server_ip[0]);
          webClient.print(((reinterpret_cast<const __FlashStringHelper *>((".")))));
          ...
          webClient.println(((reinterpret_cast<const __FlashStringHelper *>(("              },")))));
          // TOPIC
          webClient.print(((reinterpret_cast<const __FlashStringHelper *>(("              defaultTopic: \"")))));
          webClient.print(YOUR_CALL);
          webClient.print(((reinterpret_cast<const __FlashStringHelper *>(("/")))));
          webClient.print(NET_ID);
          webClient.println(((reinterpret_cast<const __FlashStringHelper *>(("/ROT/#\",")))));
          // END TOPIC
          webClient.println(((reinterpret_cast<const __FlashStringHelper *>(("              showCounter: true,")))));
          webClient.println(((reinterpret_cast<const __FlashStringHelper *>(("              alphabeticalSort: true,")))));
          webClient.println(((reinterpret_cast<const __FlashStringHelper *>(("              qos: 0")))));
          webClient.println(((reinterpret_cast<const __FlashStringHelper *>(("          };")))));
          webClient.println(((reinterpret_cast<const __FlashStringHelper *>(("          </script>")))));
          // END TOPIC
          webClient.println(((reinterpret_cast<const __FlashStringHelper *>(("      </head>")))));
          webClient.println(((reinterpret_cast<const __FlashStringHelper *>(("      <body>")))));
          webClient.print(((reinterpret_cast<const __FlashStringHelper *>(("          <div id=\"frame\" ")))));
          webClient.println(((reinterpret_cast<const __FlashStringHelper *>((">")))));
          webClient.println(((reinterpret_cast<const __FlashStringHelper *>(("              <div id=\"footer\">")))));
          webClient.println(((reinterpret_cast<const __FlashStringHelper *>(("                  <p class=\"status\" style=\"font-size: 150%;\">")))));
          // STATUS
          webClient.print(((reinterpret_cast<const __FlashStringHelper *>(("Uptime: ")))));
          if(millis() < 60000){
            webClient.print(millis()/1000);
            webClient.print(((reinterpret_cast<const __FlashStringHelper *>((" seconds")))));
          }else if(millis() > 60000 && millis() < 3600000){
            webClient.print(millis()/60000);
            webClient.print(((reinterpret_cast<const __FlashStringHelper *>((" minutes")))));
          }else if(millis() > 3600000 && millis() < 86400000){
            webClient.print(millis()/3600000);
            webClient.print(((reinterpret_cast<const __FlashStringHelper *>((" hours")))));
          }else{
            webClient.print(millis()/86400000);
            webClient.print(((reinterpret_cast<const __FlashStringHelper *>((" days")))));
          }
          webClient.print(((reinterpret_cast<const __FlashStringHelper *>((" | FW:&nbsp;")))));
          webClient.println(REV);
          webClient.print(((reinterpret_cast<const __FlashStringHelper *>(("&nbsp;| HW:&nbsp;")))));
          webClient.println(HardwareRev);
          webClient.print(((reinterpret_cast<const __FlashStringHelper *>(("&nbsp;| eth&nbsp;mac:&nbsp;")))));
          webClient.print(MACString);
          webClient.println();

          webClient.print(((reinterpret_cast<const __FlashStringHelper *>(("&nbsp;| dhcp:&nbsp;")))));
          if(DHCP_ENABLE==1){
            webClient.print(((reinterpret_cast<const __FlashStringHelper *>(("ON")))));
          }else{
            webClient.print(((reinterpret_cast<const __FlashStringHelper *>(("OFF")))));
          }
          webClient.print(((reinterpret_cast<const __FlashStringHelper *>(("&nbsp;| ip:&nbsp;")))));
          ...
          webClient.print(((reinterpret_cast<const __FlashStringHelper *>((" | MQTT&nbsp;")))));
          if(MQTT_ENABLE==true){
            webClient.print(((reinterpret_cast<const __FlashStringHelper *>(("broker&nbsp;ip:&nbsp;")))));
            webClient.print(mqtt_server_ip[0]);
            webClient.print(((reinterpret_cast<const __FlashStringHelper *>((".")))));
            webClient.print(mqtt_server_ip[1]);
            webClient.print(((reinterpret_cast<const __FlashStringHelper *>((".")))));
            ...
            webClient.print(((reinterpret_cast<const __FlashStringHelper *>(("<span style='color: #F00; font-weight: bold;'>DISABLE</span>")))));
          }

            webClient.print(((reinterpret_cast<const __FlashStringHelper *>(("&nbsp;| <a href=\"http://")))));
            webClient.println(ETH.localIP());
            webClient.print(((reinterpret_cast<const __FlashStringHelper *>((":82/update\" target=_blank>Upload&nbsp;FW</a>&nbsp;| <a href=\"https://github.com/ok1hra/IP-rotator/releases\" target=_blank>Releases</a><br><a href=\"http://")))));
            webClient.println(ETH.localIP());
            webClient.print(((reinterpret_cast<const __FlashStringHelper *>((":88\" onclick=\"window.open( this.href, this.href, 'width=620,height=710,left=0,top=0,menubar=no,location=no,status=no' ); return false;\"><button style='color: #fff; background-color: #060; padding: 5px 20px 5px 20px; margin:15px; border: none; -webkit-border-radius: 5px; -moz-border-radius: 5px; border-radius: 5px;} :hover {background-color: orange;} '>Azimuth Map Control</button></a>")))));

          // END STATUS
          webClient.println(((reinterpret_cast<const __FlashStringHelper *>(("              </p>")))));
          webClient.println(((reinterpret_cast<const __FlashStringHelper *>(("              </div>")))));
          webClient.println(((reinterpret_cast<const __FlashStringHelper *>(("              <div id=\"header\">")))));
          webClient.println(((reinterpret_cast<const __FlashStringHelper *>(("                  <div id=\"topic-box\">")))));
          webClient.println(((reinterpret_cast<const __FlashStringHelper *>(("                      <input type=\"text\" id=\"topic\" value=\"\" title=\"Topic to subscribe\">")))));
          webClient.println(((reinterpret_cast<const __FlashStringHelper *>(("                  </div>")))));
          webClient.println(((reinterpret_cast<const __FlashStringHelper *>(("              </div>")))));
          webClient.println(((reinterpret_cast<const __FlashStringHelper *>(("              <div id=\"toast\"></div>")))));
          webClient.println(((reinterpret_cast<const __FlashStringHelper *>(("              <section class=\"messages\"></section>")))));
          webClient.println(((reinterpret_cast<const __FlashStringHelper *>(("              <div id=\"footer\">")))));
          webClient.println(((reinterpret_cast<const __FlashStringHelper *>(("                  <p class=\"status\">")))));
          webClient.println(((reinterpret_cast<const __FlashStringHelper *>(("                      Client <code id=\"status-client\" title=\"Client ID\">?</code> is ")))));
          webClient.println(((reinterpret_cast<const __FlashStringHelper *>(("                      <code id=\"status-state\" class=\"connecting\"><em>&bull;</em> <span>connecting...</span></code> to ")))));
          webClient.println(((reinterpret_cast<const __FlashStringHelper *>(("                      <code id=\"status-host\">?</code>")))));
          webClient.println(((reinterpret_cast<const __FlashStringHelper *>(("                      <em>via</em> MQTT Wall 0.3.0 (<a href=\"https://github.com/bastlirna/mqtt-wall\">github</a>)")))));
          webClient.println(((reinterpret_cast<const __FlashStringHelper *>(("                      | <a href=\"https://remoteqth.com/wiki/\" target=\"_blank\">ROT Wiki</a>.")))));
          webClient.println(((reinterpret_cast<const __FlashStringHelper *>(("                  </p>")))));
          webClient.println(((reinterpret_cast<const __FlashStringHelper *>(("              </div>")))));
          webClient.println(((reinterpret_cast<const __FlashStringHelper *>(("          </div>")))));
          webClient.println(((reinterpret_cast<const __FlashStringHelper *>(("          <script type=\"text/javascript\" src=\"https://code.jquery.com/jquery-2.1.4.min.js\"></script>")))));
          webClient.println(((reinterpret_cast<const __FlashStringHelper *>(("          <script type=\"text/javascript\" src=\"https://code.jquery.com/color/jquery.color-2.1.2.min.js\"></script>")))));
          webClient.println(((reinterpret_cast<const __FlashStringHelper *>(("          <script type=\"text/javascript\" src=\"https://cdnjs.cloudflare.com/ajax/libs/paho-mqtt/1.0.1/mqttws31.min.js\"></script>")))));
          webClient.println(((reinterpret_cast<const __FlashStringHelper *>(("          <script type=\"text/javascript\" src=\"https://remoteqth.com/mqtt-wall/wall.js\"></script>")))));
          webClient.println(((reinterpret_cast<const __FlashStringHelper *>(("      </body>")))));
          webClient.println(((reinterpret_cast<const __FlashStringHelper *>(("  </html>")))));
...
String Timestamp(){
  ...
  struct timeval tv;
  gettimeofday(&tv, 
# 4172 "/media/nfs/home/mjd/Projects/IP-rotator/IP-rotator.ino" 3 4
                   __null
# 4172 "/media/nfs/home/mjd/Projects/IP-rotator/IP-rotator.ino"
                       );
  char timestamp[40];
